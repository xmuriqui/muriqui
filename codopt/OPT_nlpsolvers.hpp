...
namespace optsolvers{
    ...
    class OPT_OldIpopt : public OPT_MyNLPSolver
    {
    ...
    protected:
        ...
        virtual void __desallocateSolverEnv() override;
    ...
    public:
        ...
        #if OPT_HAVE_IPOPT
            Ipopt::SmartPtr<OPT_OldMyProblemToIpopt> mynlp;
        ...
        virtual ~OPT_OldIpopt();
        
        // __methods from Solver __
        
        virtual void desallocateMemory() override;
    ...
    /* protected:
        ...
        friend class OPT_OldMyProblemToIpopt;
    ...
    protected:
        ...
        OPT_GeneralSolverParams params;
    ...
    protected:
        ...
        //My aux derivative structure
        //size of sizeColsNzRowJac and colsNzRowJac is th number of contsraints
        int nRowsJac;
        ...
        int *sizeColsNzLagH;
        int **colsNzRowLagH;
        //end of my aux derivative structure
        
        
        int _setDoubleParameter(const char *param, const double value);
        
        int _setIntegerParameter(const char *param, const int value );
        
        int _setStringParameter(const char *param, const char *value);
        
        int _setParameters(const OPT_GeneralSolverParams &params);
        
        void desallocateMyAuxDerivativeIndexStructures();
    };
    ...
    struct OPT_ObjToOptizelle;
    struct OPT_IneqToOptizelle;
    struct OPT_EqToOptizelle;
    
    class OPT_Optizelle : public OPT_MyNLPSolver
    {
    protected:
        
        //bool *evalLinearIneqConstrs; //to eval linear inequalities constraints (optizelle requeries separation of linear inequalities)
        bool *evalEqAndNLIneqConstrs; //to eval nonlinear and linear equalities constraints
        
        bool hasQuadMatrixInConstrs;
        
        unsigned int totalConstrs; //total number of constraints to optizelle
        unsigned int totalLinIneqConstrs;
        
        unsigned int mLinIneq; //number of linear inequalities. Optizelle requires we separate these constraints from the rest.
        //unsigned int mLinEq; //number of linear equalities
        unsigned int mLinEqNL; //Nonlinear inequalities must be transformed in equalities to use optizelle
        //unsigned int mNLEq ;
        unsigned int mNLIneq;
        
        
        unsigned int *linIneqConstrs; //indices of linear inequalities
        unsigned int *linEqNLConstrs; //index of nonlinear 
        unsigned int *NLIneqConstrs;
        
        
        std::vector<double> xInit_vec;
        std::vector<double> zInit_vec; //dual variables of variable bounds [z_l; z_u]
        std::vector<double> lambdaInit_vec; //dual variable of constraints
        
        
        int allocateConstrAuxStructures(unsigned int m);
    ...
    public:
        ...
        friend struct OPT_ObjToOptizelle;
        friend struct OPT_IneqToOptizelle;
        friend struct OPT_EqToOptizelle;
    };
